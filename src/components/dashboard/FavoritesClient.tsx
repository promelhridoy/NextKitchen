...
export default function FavoritesClient() {
  ...
  const handleCreateCollection = () => {
    ...
    // TODO(wire-up): POST /api/collections { name }
    ...
    <div>
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-2xl bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-orange-600"
        >
        ...
        {FAVORITE_COLLECTIONS.map((c) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 overflow-hidden rounded-2xl border px-4 py-2 text-sm font-medium transition-colors ${
                isActive
          ...
          {recipes.length > 0 ? (
            ...
            <div className="flex flex-col items-center rounded-2xl border border-dashed border-gray-200 py-16 text-center dark:border-gray-800">
              ...
              <p className="mt-3 text-sm font-medium text-gray-500 dark:text-gray-400">
                No recipes saved in this collection yet
              </p>
            </div>
          )}
        </motion.div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          ...
          >
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-2xl bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-orange-600"
            >
