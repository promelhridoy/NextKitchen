      ...
      <div className="w-full max-w-md">
        <div className="relative rounded-sm border border-[#C9C2AC] bg-[#FDFBF5] px-8 py-10 shadow-[0_1px_0_#C9C2AC,0_8px_24px_-12px_rgba(0,0,0,0.25)] dark:border-[#3A362C] dark:bg-[#25221C]">
          ...
          <p className="mt-2 text-sm text-[#6B6656] dark:text-[#A39D89]">
            Start collecting your own recipes
          </p>

          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            <div>
              <label htmlFor="name" className="mb-1 block text-sm text-[#4A4638] dark:text-[#C9C2AC]">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="image" className="mb-1 block text-sm text-[#4A4638] dark:text-[#C9C2AC]">
                Profile Image
              </label>
              <input
                id="image"
            ...
            <div>
              <label htmlFor="confirmPassword" className="mb-1 block text-sm text-[#4A4638] dark:text-[#C9C2AC]">
                Confirm password
              </label>
              <input
                id="confirmPassword"
          ...
          <p className="mt-8 text-center text-sm text-[#6B6656] dark:text-[#A39D89]">
            ...
            <Link href="/login" className="font-medium text-[#5B7B5B] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
